            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        <webuijsf:staticText id="staticText1" style="font-size: 36px; font-weight: bold; left: 360px; top: 96px; position: absolute" text="NEW DECOR"/>
                        <webuijsf:label id="label1" requiredIndicator="true" style="position: absolute; left: 264px; top: 192px" text="Name:"/>
                        <webuijsf:textField columns="50" id="textField1" style="left: 360px; top: 192px; position: absolute"/>
                        <webuijsf:label id="label2" requiredIndicator="true" style="left: 264px; top: 168px; position: absolute" text="Type"/>
                        <webuijsf:dropDown id="dropDown1" items="#{pages$NewDecor.dropDown1DefaultOptions.options}"
                            style="left: 360px; top: 168px; position: absolute" width="250"/>
                        <webuijsf:label id="label3" requiredIndicator="true" style="left: 264px; top: 216px; position: absolute" text="Description"/>
                        <webuijsf:textArea columns="50" id="textArea1" rows="4" style="left: 360px; top: 216px; position: absolute"/>
