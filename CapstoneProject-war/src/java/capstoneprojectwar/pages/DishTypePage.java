 ...
 *
 * @version DishTypePage.java
 * @version Created on 09 26, 17, 1:59:58 PM
 * @author Acer
 */

public class DishTypePage extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("DishTypePage Initialization Failure", e);
    ...
    public void prerender() {
        ...
        DishType[] dishTypeArr = dishTypeList.toArray(new DishType[0]);

        SessionBean1 sb1 = this.getSessionBean1();
        sb1.setDishTypeArr(dishTypeArr);
    }
