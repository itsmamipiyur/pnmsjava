 ...
 * @version Created on 09 26, 17, 1:42:57 PM
 * @author Acer
 */
...
public class NewDecor extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        dropDown1DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("1", "Color Motif"), new com.sun.webui.jsf.model.Option("2", "Theme")});
    }
