 ...
 *
 * @version NewRentalPackage.java
 * @version Created on 10 5, 17, 3:32:15 PM
 * @author ChristelleAnne
 */

public class NewRentalPackage extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("NewRentalPackage Initialization Failure", e);
