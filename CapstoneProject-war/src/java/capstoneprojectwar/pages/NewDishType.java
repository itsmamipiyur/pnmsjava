 ...
 *
 * @version NewDishType.java
 * @version Created on 09 26, 17, 2:11:11 PM
 * @author Acer
 */

public class NewDishType extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("NewDishType Initialization Failure", e);
    ...
    public void prerender() {
        List<DishType> dishTypeList = this.dishTypeFacade.findAll();
        DishType dishType = dishTypeList.get(dishTypeList.size() - 1);
        String id = SmartCounter.generate(dishType.getDishTypeCode());
    ...
    public String btnSubmit_action() {
        ...
        String name = "";
        String desc = (String) this.txtDesc.getText();
        String code = (String) this.txtID.getText();
        Date dt = new Date();

        try{
            name = (String) this.txtName.getText();

            DishType dishType = new DishType();
            dishType.setDishTypeCode(code);
            dishType.setDishTypeName(name);
            dishType.setDishTypeDesc(desc);
            dishType.setCreatedAt(dt);
            dishType.setUpdatedAt(dt);
            this.dishTypeFacade.create(dishType);
