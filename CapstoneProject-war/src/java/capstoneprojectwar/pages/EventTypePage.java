 ...
 *
 * @version EventTypePage.java
 * @version Created on 09 26, 17, 1:19:25 PM
 * @author Acer
 */

public class EventTypePage extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("EventTypePage Initialization Failure", e);
    ...
    public void prerender() {
        List<EventType> eventTypeList = this.eventTypeFacade.findAllActive();
        EventType[] eventTypeArr = eventTypeList.toArray(new EventType[0]);

        SessionBean1 sb1 = this.getSessionBean1();
        sb1.setEventTypeArr(eventTypeArr);
    }
