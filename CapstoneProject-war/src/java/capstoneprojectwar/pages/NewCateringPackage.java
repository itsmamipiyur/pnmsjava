 ...
 *
 * @version NewCateringPackae.java
 * @version Created on 10 5, 17, 3:31:59 PM
 * @author ChristelleAnne
 */

public class NewCateringPackage extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("NewCateringPackae Initialization Failure", e);
...
//        List<CateringPackage> dishTypeList = this.dishTypeFacade.findAll();
