 ...
 *
 * @version NewDelivery.java
 * @version Created on 10 5, 17, 3:32:28 PM
 * @author ChristelleAnne
 */

public class NewDelivery extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("NewDelivery Initialization Failure", e);
