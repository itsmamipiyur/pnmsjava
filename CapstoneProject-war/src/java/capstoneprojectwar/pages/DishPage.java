 ...
 *
 * @version DishPage.java
 * @version Created on 09 26, 17, 2:22:14 PM
 * @author Acer
 */

public class DishPage extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("DishPage Initialization Failure", e);
    ...
    public void prerender() {
        List<Dish> dishList = this.dishFacade.findAllActive();
        Dish[] dishArr = dishList.toArray(new Dish[0]);

        SessionBean1 sb1 = this.getSessionBean1();
        sb1.setDishArr(dishArr);
    }
