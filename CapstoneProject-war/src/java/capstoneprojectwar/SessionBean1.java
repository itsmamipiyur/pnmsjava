 ...
 * @version Created on 09 23, 17, 8:18:57 AM
 * @author Acer
 */
...
public class SessionBean1 extends AbstractSessionBean {
    ...
    public void setDishArr(Dish[] dishArr) {
        this.dishArr = dishArr;
    }

    public DishType[] getDishTypeArr() {
        return dishTypeArr;
    }

    public void setDishTypeArr(DishType[] dishTypeArr) {
